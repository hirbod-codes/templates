...
export function astor(a: number): number {
...
export function fixangr(a: number): number {
    return a - (2 * Math.PI) * (Math.floor(a / (2 * Math.PI)));
}

//  DSIN  --  Sine of an angle in degrees

export function dsin(d: number): number {
    return Math.sin(dtr(d));
}

//  DCOS  --  Cosine of an angle in degrees

export function dcos(d: number): number {
...
export function jhms(j: number): number[] {
...
export function jwday(j: number): number {
...
export function obliqeq(jd: number): number {
    let eps, u, v, i;
...
export function ecliptoeq(jd: number, Lambda: number, Beta: number): number[] {
...
export function sunpos(jd: number): number[] {
